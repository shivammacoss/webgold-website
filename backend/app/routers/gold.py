...
from app.models import GoldRateSnap
from app.schemas import GoldRateOut, GoldRatePoint
...
async def history(
    ...
    rows = await GoldRateSnap.find(GoldRateSnap.fetched_at >= since).sort("+fetched_at").to_list()
