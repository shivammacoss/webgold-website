...
export function AnimatedLetterText({
  ...
  if (replaceIndex === -1) {
    return (
      <span className={cn("font-black tracking-tight text-brand-fg", className)}>
        {text}
      </span>
    );
  }
  ...
  return (
    <span className={cn("inline-flex items-center font-black tracking-tight text-brand-fg", className)}>
